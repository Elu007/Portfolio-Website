  ...
  return (
    <>
      ...
      <div className='flex flex-wrap justify-center bg-gray-700'>
        ...
        {/* TextUtils app */}
        <ProjectCard projectName="TextUtils" imageSrc="/images/textutils.jpg" description="Text utility app built with ReactJs that has a dark mode toggle feature." demoLink="https://elu007.github.io/TextUtils/" sourceLink="https://github.com/Elu007/TextUtils" />
